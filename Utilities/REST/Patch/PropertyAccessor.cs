...
namespace Utilities {
	...
	internal abstract class PropertyAccessor<TEntityType> where TEntityType : class {
		...
		protected PropertyAccessor(PropertyInfo property) {
			...
			Property = property;
			if(Property.GetGetMethod() == null || Property.GetSetMethod() == null) throw new ArgumentException("Property Must Have Public Getter And Setter", "property");
		}

		public PropertyInfo Property { get; private set; }

		public void Copy(TEntityType from, object to) {
