...
namespace Utilities {
	...
	public class Delta<TEntityType> : DynamicObject where TEntityType : class {
		...
		public void CopyChangedValues(object original) {
			if(original == null) throw new ArgumentNullException("original");
			if(!_entityType.IsInstanceOfType(original)) throw new ArgumentException("Delta type mismatch", "original");
		...
		/// </summary>
		/// <param name="original">The entity to be updated.</param>
		public void Apply(object original) {
		...
		private Dictionary<string, PropertyAccessor<TEntityType>> InitializePropertiesThatExist() {
			return propertyCache.GetOrAdd(
				...
				backingType => backingType
					...
					.ToDictionary(p => p.Property.Name.ToCamelCase()));
		}
